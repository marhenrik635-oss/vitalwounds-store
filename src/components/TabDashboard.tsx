    ...
    <div className="space-y-2">
      {productCounts.map(([name, count]) => (
        <div key={name} className="flex items-center gap-2">
          ...
          <div className="flex-1 h-5 rounded-full bg-vw-bg overflow-hidden border border-vw-border/60">
            <div
              className="h-full rounded-full bg-vw-accent/50 transition-all duration-500"
